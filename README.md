...
<!-- PROJECT TITLE -->
<h1 align='center'id="top"> :rocket: == Site de Receitas == :rocket: </h1>


<!-- PROJECT SOBRE -->
<h2 id="sobre">:notebook: Sobre </h2>
<p align="justify">O objetivo desse projeto era criar um site onde o usuário poderia fazer cadastro e também o login para ter acesso a uma lista de receitas. E tabém é possível o usuário cadastrar uma receita</p>
...
- [x] Tela de Login
- [x] Tela para Cadastrar Receitas;
- [x] Tela de Detalhes;

### Integração com API
- [x] Listagem de Receitas;
- [x] Get Receitas;
- [x] Get Receitas details;
- [x] Get Usuário;
- [x] Post Cadastro;
- [x] Post Login
- [x] Post Receitas
